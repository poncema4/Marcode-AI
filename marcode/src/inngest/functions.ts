...
import { getSandbox, lastAssistTextMessageContent, parseAgentOutput } from "./utils";
import { z } from "zod";
...
export const codeAgentFunction = inngest.createFunction(
  ...
  async ({ event, step }) => {
        ...
        lifecycle: {
          onResponse: async ({ result, network }) => {
            const lastAssistantMessageText =
              lastAssistTextMessageContent(result);
    ...
    // Use the network to run the agent
